            ...
            @if ($ingredients)
                ...
                @foreach ($ingredients as $ingredient)
                    <tr class="ingredient-row" data-row="{{ $row_counter }}">
                        <td>{!! Form::select('ingredient_type[' . $row_counter . ']', ['Item' => 'Item', 'MultiItem' => 'Multi Item', 'Category' => 'Category', 'MultiCategory' => 'Multi Category', 'Currency' => 'Currency'], $ingredient->ingredient_type, [
