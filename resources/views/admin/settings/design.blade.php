        ...
        <div class="card-body">
            @foreach ($fonts as $font)
                <div class="row border border-bottom p-2">
                    <b>{{ $font }}</b>
                    <span class="ml-auto" style="font-family: {{ $font }}; font-size: 20px;">Lorem ipsum dolor sit amet,</span> <span style="font-family: {{ $font }}; font-size: 20px;text-transform:uppercase;"> consectetur adipiscing
                        elit.</span>
                </div>
            @endforeach
        </div>
