...
<p>
    Upload an image for the foreground that will go in top a character's image. Notice that the image will need to be transparent for this to work.  You may stack multiple foregrounds on a character, provided it is transparent and follows the image size.
